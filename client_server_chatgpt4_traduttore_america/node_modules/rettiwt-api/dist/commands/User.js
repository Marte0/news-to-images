...
function createUserCommand(rettiwt) {
    ...
    user.command('details')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rettiwt.user.details(id)];
                case 1:
                    details = _a.sent();
    ...
    user.command('following')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rettiwt.user.following(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    users = _a.sent();
    ...
    user.command('followers')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rettiwt.user.followers(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    users = _a.sent();
                    (0, CliUtils_1.output)(users);
                    return [2 /*return*/];
    ...
    user.command('likes')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rettiwt.user.likes(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    users = _a.sent();
                    (0, CliUtils_1.output)(users);
                    return [2 /*return*/];
    ...
    user.command('timeline')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rettiwt.user.timeline(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    users = _a.sent();
                    (0, CliUtils_1.output)(users);
                    return [2 /*return*/];
    ...
    user.command('replies')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rettiwt.user.replies(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    users = _a.sent();
                    (0, CliUtils_1.output)(users);
                    return [2 /*return*/];
