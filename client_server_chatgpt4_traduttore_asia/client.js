...
image1.src = "https://cbkfspvaaiewasutjomn.supabase.co/storage/v1/object/public/news-to-image/1709886951057.jpg";
...
async function updateState(obj) {
  ...
  const { data, error } = await supabase.from("asia").upsert({ id: obj.id, used: "TRUE" }).select();
}
